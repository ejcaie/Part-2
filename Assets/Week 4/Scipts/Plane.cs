...
public class Plane : MonoBehaviour
{
    ...
    public List<Sprite> planeSprite;
    private void Start()
    {
        ...
        spriteRenderer.sprite = planeSprite[Random.Range(0, 4)];
    }
    ...
    {
        if (Vector3.Distance(gameObject.transform.position, collision.transform.position) <= 0.5f)
        {
            Destroy(gameObject);
        }
    }
